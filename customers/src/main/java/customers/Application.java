...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println("***************** Part a sorted by age in ascending ********************");
		customerCollection.print();
		System.out.println("***************** Part b.1 filter by city(Chicago) ********************");
		Predicate<Customer> cityPredicate = p -> p.getAddress().getCity().equals("Chicago");
		customerCollection.printFilterIterator(cityPredicate);
		System.out.println("***************** Part b.2 filter by zipcode(startwith12)********************");
		Predicate<Customer> zipPredicate = p -> p.getAddress().getZip().startsWith("12");
		customerCollection.printFilterIterator(zipPredicate);
		System.out.println("***************** Part c skipping customer(alternate customer)********************");
		customerCollection.printSkipCustomer();
	}
